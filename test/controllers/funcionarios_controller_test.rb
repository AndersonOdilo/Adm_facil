...
class FuncionariosControllerTest < ActionController::TestCase
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post :create, funcionario: { carteira_trabalho: @funcionario.carteira_trabalho, cod: @funcionario.cod, data_admissao: @funcionario.data_admissao, salario: @funcionario.salario }
    end
  ...
  test "should update funcionario" do
    patch :update, id: @funcionario, funcionario: { carteira_trabalho: @funcionario.carteira_trabalho, cod: @funcionario.cod, data_admissao: @funcionario.data_admissao, salario: @funcionario.salario }
    assert_redirected_to funcionario_path(assigns(:funcionario))
  end
