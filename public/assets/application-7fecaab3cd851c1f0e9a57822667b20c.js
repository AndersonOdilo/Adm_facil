  ...
  $(function() {
    $('#salvar_cliente').on("click", function() {
      if ($('#new_pessoa_fisica').length) {
        ...
        return $('#new_pessoa_fisica').submit();
      } else if ($('#new_pessoa_juridica').length) {
        $('#new_pessoa_juridica').validate();
        $('#new_cliente').validate();
        return $('#new_pessoa_juridica').submit();
      }
    });
    return $('#new_cliente').bind('ajax:success', function(event, data, status, xhr) {
      $('#cliente_nome').val(data.pessoa.nome);
      $('#pedido_cliente_id').val(data.id);
      return $('#novo_cliente').modal('hide');
    });
  });
...
(function() {
  $(function() {
        ...
        return $.ajax({
          ...
          success: function(data) {
            ...
            for (i = 0, len = data.length; i < len; i++) {
              ...
              results.push($('#select_cidade').append(op));
            }
            return results;
          },
          error: function(data) {
        ...
        return $.ajax({
          ...
          success: function(data) {
            ...
            for (i = 0, len = data.length; i < len; i++) {
              ...
              results.push($('#select_bairro').append(op));
            }
            return results;
          },
          error: function(data) {
    ...
    return $('#select_bairro').on("change", function() {
      var id;
        ...
        return $.ajax({
          ...
          success: function(data) {
            ...
            for (i = 0, len = data.length; i < len; i++) {
              ...
              results.push($('#select_rua').append(op));
            }
            return results;
          },
          error: function(data) {
...
(function() {
  $(function() {
    ...
    return $('#new_fornecedor').bind('ajax:success', function(event, data, status, xhr) {
      $('#produto_fornecedor_id').append($('<option/>').attr('value', data.id).text(data.pessoa.nome).attr('selected', 'selected'));
      return $('#novo_fornecedor').modal('hide');
    });
  });
...
(function() {
  $(function() {
    return $('#salvar_funcionario').on("click", function() {
      if ($('#new_pessoa_fisica').length) {
        $('#new_pessoa_fisica').validate();
...
(function() {
  $(function() {
    var remover_item;
    $('#add_item_orcamento').on("click", function() {
      return $.ajax({
    ...
    remover_item = function(elemento, produto, quantidade) {
      return $.ajax({
        ...
        success: function(data) {
          ...
          return elemento.parentElement.parentElement.remove();
        }
      });
    };
    return window.remover_item = remover_item;
  });
...
(function() {
  $(function() {
    $('#estado_pessoas_fisicas').on("click", function() {
      return $.ajax({
    ...
    $('#estado_pessoas_juridicas').on("click", function() {
      return $.ajax({
    ...
    return $('.numero').keypress(function(event) {
      var tecla;
...
(function() {
  $(function() {
    $('#new_pessoa_fisica').bind('ajax:success', function(event, data, status, xhr) {
      ...
      if ($('#new_fornecedor').length) {
        ...
        return $('#new_funcionario').submit();
      }
    });
    $(".cpf").mask("999.999.999-99");
    $(".rg").mask("99.999.999-9");
    return $(".fone").mask("(99)9999-9999");
  });

}).call(this);
(function() {
  $(function() {
    $('#new_pessoa_juridica').bind('ajax:success', function(event, data, status, xhr) {
      $('#pessoa_id').val(data.id);
      if ($('#new_fornecedor').length) {
        return $('#new_fornecedor').submit();
      } else if ($('#new_cliente').length) {
...
(function() {
  $(function() {
    return $('#salvar_produto').on("click", function() {
      $('#new_produto').validate();
      return $('#new_produto').submit();
    });
  });
...
(function() {
  $(function() {
    var remover_item_venda;
    $('#add_item_venda').on("click", function() {
      var quantidade;
      quantidade = $('#produto_quantidade').val();
    ...
    remover_item_venda = function(elemento, produto, quantidade) {
      return $.ajax({
    ...
    $('#finalizar_pedido').on("click", function() {
      if ($('#cliente_id').val() !== "") {
        if ($('#venda_forma_pagamento_id').val() === '5') {
          return $('#pagamento_modal').modal('show');
        } else {
    ...
    return $('#finalizar_pagamento').on("click", function() {
